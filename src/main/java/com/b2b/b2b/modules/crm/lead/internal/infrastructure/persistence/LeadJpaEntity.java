package com.b2b.b2b.modules.crm.lead.internal.infrastructure.persistence;
...
@AllArgsConstructor
@NoArgsConstructor
public class LeadJpaEntity extends BaseEntity implements PipelineAssignable<LeadPipeline, LeadPipelineStage>, WorkflowTarget {
    ...
    public LeadJpaEntity(String leadEmail, String leadName, String leadPhone) {
